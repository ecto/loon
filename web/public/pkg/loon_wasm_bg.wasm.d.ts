...
export const has_gpu_bridge: () => number;
export const infer_type: (a: number, b: number) => [number, number, number, number];
export const init_dom_bridge: (a: any) => void;
export const init_gpu_bridge: (a: any) => void;
export const invoke_callback: (a: number) => void;
export const place_resume: (a: number, b: number) => [number, number, number];
export const place_start: (a: number, b: number, c: number, d: number) => [number, number, number];
