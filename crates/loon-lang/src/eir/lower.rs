...
pub fn resolve_builtin_name(name: &str) -> Option<Built> {
    {
        match name {
            ...
            "buf" => Some(Built::BufNew),
            "buf-i32" => Some(Built::BufNewI32),
            "buf-f64" => Some(Built::BufNewF64),
            "buf-zeros" => Some(Built::BufZeros),
            "buf-zeros-i32" => Some(Built::BufZerosI32),
            "buf-len" => Some(Built::BufLen),
            "buf->vec" => Some(Built::BufToVec),
            "buf-dtype" => Some(Built::BufDtype),
            "at" => Some(Built::BufAt),
            "put" => Some(Built::BufPut),
